...
def plot_training_results():
    ...
    plots_dir = os.path.join(current_dir, 'plots_100')
    ...
    plot_metric(
        rewards, 
        'MMC (100 Episodes) Training Reward', 
        'Total Reward', 
    ...
    plot_metric(
        losses, 
        'MMC (100 Episodes) Training Loss (MSE)', 
        'Loss', 
    ...
    if not turnovers.empty:
        plot_metric(
            turnovers, 
            'MMC (100 Episodes) Portfolio Turnover', 
            'Turnover', 
    ...
    if not tracking_errors.empty:
        plot_metric(
            tracking_errors, 
            'MMC (100 Episodes) Average Tracking Error', 
            'Tracking Error', 
